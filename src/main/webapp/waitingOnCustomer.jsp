...
<title>Waiting On Customer</title>
...
<style type="text/css">
	...
	<div class="m-2" >
		...
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" id="editTicket" onclick="updateTicketDetails()">Edit Ticket</button>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <button type="button" class="btn btn-primary" id="updateTicket">Save</button>
...
<script type="text/javascript">
    ...
    function refresh_grid() {
        ...
        fetch("http://localhost:8080/reportapplication/rest/support/waitingOnCustomer/tickets")
    ...
    function updateTicketDetails() {
    	...
    	for (const key in rowData) {
    	    ...
    	    if (rowData.hasOwnProperty(key)) {
    	    	...
    	    	if(rowData.ticketstatus === 'Waiting On Customer') {
    	    		document.getElementById('waitingOnCustomer').checked = true;
    	    	} else {
    	    		document.getElementById('waitingOnCustomer').checked = false;
    	    	}
    ...
    function updateTicket() {
    	...
    	if(bug.value === '' || client.value === '' || category.value === '' || dateCreated.value === '' || dateSolved.value === '' || page.value === ''|| 
    			platform.value === '' || primaryAssignee.value === '' || supportiveAssignee.value === '' || ticketLink.value === ''|| ticketstatus.value === '' ||
    			user.value === '' || week.value === '') {
        	...
        	console.log("Log - " + jsonObjectUpdated.ticketid )
	 	  
	 	 
	 	    var put_url = "http://localhost:8080/reportapplication/rest/support/ticket/" + jsonObjectUpdated.ticketid;
	 	    	   
	 	    var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
	 	    	
	 	    xmlhttp.open("PUT", put_url);
	 	    xmlhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
	 	    xmlhttp.send(JSON.stringify(jsonObjectUpdated));
 
	 	   showAlert("Ticket has been successfully updated!", "success");
    ...
    function showAlert(message, className) {
		...
		// div.style.right = "600px";
		 ...
		 const form = document.querySelector('.exampleModalLabel');
	...
	document.getElementById("updateTicket").addEventListener('click', (e) => {
