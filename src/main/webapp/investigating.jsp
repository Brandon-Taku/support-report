...
<style type="text/css">
	...
	<div class="container mt-4">
      	  ...
      	  <div class="text-center">
			    ...
			    <a href="/reportapplication/rest/suppport/inProgress"><button type="button" class="btn btn-secondary btn-circle btn-xl mb-4"><h4>In-Progress</h4><h2 class="mt-1"><br>0</br></h2></button></a>
...
function deselect(){
    ...
    function refresh_grid() {
        ...
        fetch("http://localhost:8080/reportapplication/rest/support/investigating/tickets")
